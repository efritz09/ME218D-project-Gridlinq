...
#define SERV_0_HEADER "Gridlinq.h"
// the name of the Init function
#define SERV_0_INIT InitGridlinq
// the name of the run function
#define SERV_0_RUN RunGridlinq
...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "Wind.h"
// the name of the Init function
#define SERV_1_INIT  InitWind
// the name of the run function
#define SERV_1_RUN  RunWind
// How big should this services Queue be?
...
#if NUM_SERVICES > 2
// the header file with the public function prototypes
#define SERV_2_HEADER "Clamp.h"
// the name of the Init function
#define SERV_2_INIT InitClamp
// the name of the run function
#define SERV_2_RUN RunClamp
// How big should this services Queue be?
...
#if NUM_SERVICES > 3
// the header file with the public function prototypes
#define SERV_3_HEADER "GPS.h"
// the name of the Init function
#define SERV_3_INIT InitGPS
// the name of the run function
#define SERV_3_RUN RunGPS
// How big should this services Queue be?
#define SERV_3_QUEUE_SIZE 30
#endif
...
#if NUM_SERVICES > 4
// the header file with the public function prototypes
#define SERV_4_HEADER "Xbee.h"
// the name of the Init function
#define SERV_4_INIT InitXbee
// the name of the run function
#define SERV_4_RUN RunXbee
// How big should this services Queue be?
...
#if NUM_SERVICES > 5
// the header file with the public function prototypes
#define SERV_5_HEADER "XbeeComms.h"
// the name of the Init function
#define SERV_5_INIT InitXbeeComms
// the name of the run function
#define SERV_5_RUN RunXbeeComms
// How big should this services Queue be?
...
#if NUM_SERVICES > 6
// the header file with the public function prototypes
#define SERV_6_HEADER "CompassCom.h"
// the name of the Init function
#define SERV_6_INIT InitCompassCom
// the name of the run function
#define SERV_6_RUN RunCompassCom
// How big should this services Queue be?
...
#if NUM_SERVICES > 7
// the header file with the public function prototypes
#define SERV_7_HEADER "LidarCom.h"
// the name of the Init function
#define SERV_7_INIT InitLidarCom
// the name of the run function
#define SERV_7_RUN RunLidarCom
// How big should this services Queue be?
...
#if NUM_SERVICES > 8
// the header file with the public function prototypes
#define SERV_8_HEADER "I2C.h"
// the name of the Init function
#define SERV_8_INIT InitI2C
// the name of the run function
#define SERV_8_RUN RunI2C
// How big should this services Queue be?
...
#if NUM_DIST_LISTS > 0 
#define DIST_LIST0 PostWind, PostGPS
#endif
#if NUM_DIST_LISTS > 1 
...
#define TIMER0_RESP_FUNC PostClamp
#define TIMER1_RESP_FUNC PostWind
#define TIMER2_RESP_FUNC PostGPS
#define TIMER3_RESP_FUNC PostXbeeComms
#define TIMER4_RESP_FUNC PostXbee
#define TIMER5_RESP_FUNC PostClamp
